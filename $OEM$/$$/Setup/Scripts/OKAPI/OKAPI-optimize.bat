...
If %PROCESSOR_ARCHITECTURE%==x86 start /wait %cdrom%\post\jre-8u281-windows-i586.exe /s AUTO_UPDATE=0 REBOOT=Suppress REMOVEOUTOFDATEJRES=1
If %PROCESSOR_ARCHITECTURE%==IA64 start /wait %cdrom%\post\jre-8u281-windows-x64.exe /s AUTO_UPDATE=0 REBOOT=Suppress REMOVEOUTOFDATEJRES=1
If %PROCESSOR_ARCHITECTURE%==AMD64 start /wait %cdrom%\post\jre-8u281-windows-x64.exe /s AUTO_UPDATE=0 REBOOT=Suppress REMOVEOUTOFDATEJRES=1
